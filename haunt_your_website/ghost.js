...
//
function ghost_init (show_bootup, params) {
  //
  ...
  ghost_sleep.innerHTML = params.sleepHTML || '<p>zZzZZZZzzzZz</p>'
  // booing
  ...
  ghost_boo.innerHTML = params.booHTML || '<p>BoOoOoOoo</p>'
  // talking
  ...
  ghost_talk.innerHTML = params.talkHTML || '<p>BoOoOoOoo</p>' // TODO: change here to fun stuff
  // default (idle)
  ...
  ghost_default.innerHTML = params.defaultHTML || '<p>BOOOO</p>'
  //
