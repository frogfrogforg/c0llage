...
export class Ecto {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Ecto.prototype);
        obj.ptr = ptr;
    ...
    */
    static new(cid, w, h) {
        var ptr0 = passStringToWasm0(cid, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.ecto_new(ptr0, len0, w, h);
        return Ecto.__wrap(ret);
    }
    /**
    */
    start() {
        wasm.ecto_start(this.ptr);
    }
    /**
    */
    tick() {
